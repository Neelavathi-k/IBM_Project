...
<center>
		...
		<a href="http://localhost:8080/HRProject/HomePage.jsp"><input type="submit" value="Back"></a>
		
		<button type="submit">Sign in</button>
		<a href="UserLogin.jsp"><input type="submit" value="New Account"> </a>
		...
		<c:choose>
			<c:when test="${u == row.EMPLOYEE_ID}">
				<sql:query var="ps" dataSource="${dbconnection}">
					SELECT pass_word FROM employees WHERE EMPLOYEE_ID=="id";
				</sql:query>
